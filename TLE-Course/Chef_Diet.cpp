...
/*
     Observations -  if the protien he bought is > his need (k) it will be carry forward to the next
   day so if(a[i] > k) carry = a[i] - k if at any day a[i] < k with carry too we return the index
   with 1 based indexing return i+1;
